...
{
    //[ExerciseTestFixture("dotnet2", "H03", "Exercise05", @"Exercise5\WrapPanelWindow.xaml")]
    [TestFixture]
    ...
    public class WrapPanelWindowTests
    {
        ...
        [MonitoredTest("The WrapPanel has to be in the second row of the Grid"), Order(4)]        public void _04_HorizontalWrapPanelHasToBeInTheSecondRowOfTheGridAndContains7Ellipses()
        {
        ...
        [MonitoredTest("The orientation of the WrapPanel has to be vertical when clicking the Vertical RadioButton "), Order(5)]
        ...
        [MonitoredTest("The orientation of the WrapPanel has to be horizontal when clicking the Horizontal RadioButton "), Order(6)]
